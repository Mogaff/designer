      ...
      <main className="max-w-7xl mx-auto pt-12 px-4 lg:px-6 flex-grow flex flex-col">
        <section className="flex-grow flex flex-col">
          ...
          <div className="flex flex-col h-full">
            <div className="fixed top-[60px] right-0 bottom-0 h-screen w-[20%] z-10 hidden lg:block pr-2 pl-2 py-2 overflow-hidden">
            ...
            <div className="glass-panel p-4 flex-grow overflow-hidden flex flex-col lg:mr-[20%]">
