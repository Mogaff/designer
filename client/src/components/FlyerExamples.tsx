  ...
  return (
    <section>
      <div className="flex items-center justify-center mb-8">
        ...
        <h2 className="text-2xl font-bold gradient-text">Inspire Your Design</h2>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        {/* Example 2 */}
        <div className="glass-card overflow-hidden hover:shadow-lg transition-all">
          <div className="aspect-[1/1.414] bg-gradient-to-r from-amber-500 to-orange-500 p-6 relative rounded-xl overflow-hidden">
            <div className="text-center">
              <div className="w-16 h-16 mx-auto bg-white/60 backdrop-blur-md rounded-full mb-4"></div>
              <h3 className="text-white text-xl font-serif mb-2">Artisan Coffee Tasting</h3>
              <p className="text-white/90 text-sm mb-6">Experience the finest selection of single-origin beans</p>
              <div className="w-full h-40 bg-white/20 backdrop-blur-sm rounded-xl mb-6"></div>
              <p className="text-white/90 text-sm">Saturday, October 15th • 2-5pm</p>
              <p className="text-white/90 text-sm">The Roastery • 123 Main Street</p>
              <p className="text-white font-medium mt-4">RSVP Required</p>
            </div>
          </div>
          <div className="p-4">
        ...
        {/* Example 3 */}
        <div className="glass-card overflow-hidden hover:shadow-lg transition-all">
          <div className="aspect-[1/1.414] bg-gradient-to-b from-slate-900 to-slate-800 p-6 relative rounded-xl overflow-hidden">
            <div className="flex flex-col justify-between h-full">
              ...
              <div>
                ...
                <div className="inline-block px-4 py-2 bg-primary text-white font-bold text-sm rounded-full">Register Now</div>
              </div>
            </div>
          </div>
          <div className="p-4">
